...
class _FinancialSetupScreenState extends State<FinancialSetupScreen> {
  ...
  Future<void> _continueToApp() async {
    ...
    final expenses = double.parse(_expensesController.text.trim());
    final savingsGoal = double.parse(_savingsGoalController.text.trim());
    final bnpl = double.parse(_bnplController.text.trim());
